    ...
    <section id='product' className={layout.sectionReverse}>
      <div className={layout.sectionImgReverse}>
        <img src={bill} alt="billing" 
          ...
          <div className='absolute x-[3] -left-1/2 top-0 w-[50%] h-[50%] rounded-full white__gradient'/>
          <div className='absolute x-[0] -left-1/2 bottom-0 w-[50%] h-[50%] rounded-full pink'/>
      </div>
      ...
      <div className={layout.sectionInfo}>
        ...
        <div className='flex flex-row flex-wrap sm:mt-10 m5-6'>
